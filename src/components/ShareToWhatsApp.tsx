 ...
 *
 * Builds a formatted, emoji-rich message and opens WhatsApp's universal
 * share link via wa.me — which routes to the native WhatsApp app on
 * mobile and WhatsApp Web on desktop, preserving emojis and the link.
 */
...
interface ShareToWhatsAppProps {
  ...
  /** Optional explicit URL; defaults to {origin}/opportunity/{id} */
  detailUrl?: string;
  /** Render only icon (true) or full button with label */
  iconOnly?: boolean;
  className?: string;
}
