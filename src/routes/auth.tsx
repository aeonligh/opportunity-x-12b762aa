      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface border border-border rounded-2xl p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mb-4 py-2.5 rounded-xl border border-border bg-background hover:bg-surface transition flex items-center justify-center gap-2 text-sm font-medium"
          >
          ...
          <form onSubmit={handleEmail} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 rounded-xl bg-accent text-accent-foreground font-semibold text-sm hover:opacity-90 transition flex items-center justify-center gap-2"
            >
