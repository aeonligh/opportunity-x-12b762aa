...
| **C-18** | **Opportunities that neither are nor route to an institution.** *Third scoping — R-15 narrowed R-14's.* Not domain novelty (NELFUND launched new and was fully discoverable) and not organiser weight either (ZEANI, a small NGO, was announced by University of Nigeria Nsukka). **The variable is routing:** an opportunity acquires an institutional announcer when routed to an institution whose community it affects. The residue is opportunities whose organiser neither *is* an institution nor *routes* to one, published on an independent registrable domain. DCP is the only instance in a 20-case corpus — and atypical, having originated *inside* a university that still appears not to have announced it. **Not a structural hole on current evidence. Residue unmeasured, and unmeasured is not small.** |
...
| **R-16** | **Assemble a corpus of opportunities that demonstrably reached real Nigerian students, sampled independently of web discoverability**, and establish for each whether an enumerable institutional announcer existed and how early. Requires asking students, not searching. **The first question in the project that cannot be answered by analysis.** |
| **R-15** | **What proportion of opportunities reaching Nigerian students are announced by at least one enumerable institution?** Sets the coverage ceiling of institutional channel monitoring and quantifies C-18's residue. If small, C-18 is a documented edge case; if large, it is a live constitutional problem. |
| **R-14** | **How are previously unknown sources discovered?** `ulesarb.org` had no prior existence. Institutional crawling cannot reach such domains by construction. What mechanism finds an opportunity whose publisher is unknown until the opportunity exists — and can it avoid C-18's dependency? |
